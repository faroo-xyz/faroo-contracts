...
save('excluded-selectors.json',excluded);save('core-bytecode.json',{profile,sizes,parity,oracle_adapter:'DEFERRED_INTERFACE_ONLY',vault_pressure:'HIGH: Request and objective solvency implemented; other business remains skeleton. Remaining budget is not a full-product size prediction'});
